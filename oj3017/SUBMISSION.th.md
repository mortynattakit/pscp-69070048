...
```text
โจทย์ต้องการให้เรานำ input ที่ได้นั่นคือจำนวนเงินเฉพาะค่าอาหาร มาบวกค่าบริการตามเงื่อนไขที่กำหนด และเพิ่มค่า vat หลังจากบวกค่าบริการกับค่าอาหารแล้วอีก 7%
```
...
```
Step 1: เริ่มจากการทำความเข้าใจโจทย์ว่า input คืออะไร โจทย์ต้องการให้เราทำอะไรกับ input ซึ่งนั่นคือการเพิ่มค่าบริการและ vat
Step 2: หลังจากเข้าใจโจทย์เสร็จ ก็ทำการบวกค่าบริการเพิ่มตามเงื่อนไขที่กำหนดครับซึ่งอยู่ในช่วง 50-1000 และทำการบวกค่า vat อีก 7%
Step 3: สุดท้ายก็ลงมือทำตามที่เราคิดมาและ print ผลลัพธ์ครับ
```
...
```text
โดยสุดท้ายเนื่องจาก PEP8 ผมได้ทำการลบเงื่อนไขของ if else ที่เกี่ยวกับค่าบริการออกและทำการใช้ built in function นั่นคือ max(ค่าบริการ, 50) และ min(ค่าบริการ, 1000) แทนและทำการ + ค่าบริการที่ได้คิดไปและค่า vat 7% เพื่อทำการ print ผลลัพธ์ในตอนท้ายครับ
```
...
```text
ด้วยความที่ผมยังไม่มั้นใจในการใช้ min/max แทนการใช้ if else ของค่าบริการขนาดนั้นผมจึงอยากลองดูครับว่าผลจะได้ตามที่อยากได้หรือไม่ (รอบนี้เป็นของค่าบริการ < 50)
```
...
```text
ด้วยความที่ผมยังไม่มั้นใจในการใช้ min/max แทนการใช้ if else ของค่าบริการขนาดนั้นผมจึงอยากลองดูครับว่าผลจะได้ตามที่อยากได้หรือไม่
```
...
```text
ด้วยความที่ผมยังไม่มั้นใจในการใช้ min/max แทนการใช้ if else ของค่าบริการขนาดนั้นผมจึงอยากลองดูครับว่าผลจะได้ตามที่อยากได้หรือไม่ (50 < ค่าบริการ < 1000) และลองทำให้ผลลัพธ์เป็นทศนิยม
```
