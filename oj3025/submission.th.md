...
```text
โจทย์จะกำหนดเดือนและวันมา โดยเราจะต้องเขียนโปรแกรมให้ดูว่าวันและเดือนนี้มีฤดูกาลอะไร
Input:
ได้รับจำนวนเต็มเป็นค่าของเดือน
ได้รับจำนวนเต็มเป็นค่าของวันที่
Output
ฤดูกาล (spring, summer, fall, winter)
Constraints:
หากค่าเดือนหาร 3 ลงตัวและวันที่อยู่วันที่ 21 เป็นต้นไปจะต้องเปลี่ยนเดือนเป็นเดือนถัดไปจากวันที่แล้ว ดังนั้นจะต้องเขียนเงื่อนไขสำหรับเรื่องนี้เพิ่ม
```
...
```text
Step 1: รับค่าเดือนและวันเป็นจำนวนเต็ม
Step 2: เขียน if else โดยดูจากเดือนว่าอยู่เดือนอะไร
Step 3: ดูว่าเดือนนี้หาร 3 ลงตัวและอยู่วันที่ 21 เป็นต้นไปหรือไม่
Step 4: บอกเดือน
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรกโดยใช้ if else ในการดูเดือน และดูวันและเดือนว่าวัน >= 21 และเดือนหารสามลงตัวหรือไม่ตามลำดับ หากใช่จึงไปฤดูถัดไป หากไม่ใช่จะเป็นฤดูตาม 3 เดือน
```
...
```text
ตรวจว่าหากใส่ค่าที่ตรงกับ if else อันแรกจะรันหรือไม่
```
...
```text
ตรวจว่าหากเงื่อนไขตรงกับ nested loop โค้ดจะรันตรงตามที่อยากได้หรือไม่
```
...
```text
ตรวจสอนเงื่อนไขในฤดูอื่นว่าจะถูกหรือไม่
```
