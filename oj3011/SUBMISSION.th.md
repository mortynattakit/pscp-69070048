...
```text
โจทย์ต้องการให้เรานำ input ซึ่งก็คือแม่สี 2 สี นำมาหาว่าเมื่อผสมกันแล้วจะได้สีอะไร โดยหากเป็นสีที่ไม่ใช่แม่สีจะให้เป็น "Error" แทน
```
...
Step 2: หลังจากเข้าใจโจทย์เสร็จ ต้องลองคิดความเป็นไปได้ของเงื่อนไขครับ ว่าการผสมสีอาจเป็นการผสมสีีะหว่างสีอะไรได้บ้าง และมีเงื่อนไขอะไรที่เราอาจไม่คาดคิดหรือไม่
Step 3: สุดท้ายก็ลงมือทำตามที่เราคิดมาและแก้ไข/เพิ่มเงื่อนไขที่เราคิดว่าพลาดครับ
```
...
```text
สุดท้ายที่ผมคิดมาก็จะได้เงื่อนไขมาดังนี้ก็คือจะมีการนำ สี 2 แม่สี (เช่น yellow and red or red and yellow) และแม่สีที่เหมือนกัน (เช่น blue and blue) และสีที่ต่างก็จะเป็น error ครับ
```
...
```text
เป็นการดูครับว่า input หลักตามที่โจทย์อยากได้จะใช้ได้จริงหรือไม่
```
...
```text
ด้วยความที่มันมีโอกาสที่ user จะทำการ input แม่สีเดียวกันเพื่อให้ได้สีเดียวกันเหมือนเดิมผมจึงลองใช้ testcase นี้ครับ
```
...
```text
เนื่องจากเงื่อนไข testcase ยังขาดเงื่อนไขที่ไม่ใช่แม่สีครับ ผมเลยอยากลองโดยการนำชื่อสีมั่วๆลองไปใส่ดู
```
