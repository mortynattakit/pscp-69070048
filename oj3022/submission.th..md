...
```text
โจทย์กำหนดให้เรานำอุณหภูมิที่ได้นำมาเปลี่ยนค่าองศาเป็นค่าองศาที่ต้องการ (เช่น C --> F)
Input:
ค่าอุณหภูมิขององศาปัจจุบัน เป็น float
ค่าองศาปัจจุบัน เป็น string
ค่าองศาที่ต้องการ เป็น string
Output:
ค่าอุณหภูมิขององศาที่ต้องการ (float)
Constraints:
ต้องมีการเขียนเงื่อนไขที่ชัดเจนและต้องระเอียดรอบคอบ เพื่อไม่ให้มีสมการใดผิดหรือตกหล่น
```
...
```text
Step 1: อ่านค่า input ทั้ง 3 อย่าง (อุณหภูมิ, อุณหภูมิเก่า, อุณหภูมิใหม่)
Step 2:เขียนเงื่อนไข if else ทุกความเป็นไปได้ระหว่างองศาเก่าและองศาใหม่
Step 3: เขียนสมการเพื่อแปลงแต่ละค่าองศาให้เป็นองศาที่ต้องการและตรวจสอบอีกครั้งว่าถูกหรือไม่
Step 4: print ค่าองศาที่ต้องการออกมา

โดยได้รับความช่วยเหลือจากเพื่อนให้มาช่วยดูสมการที่ตัวเองเขียนว่ามีเงื่อนไขใดที่ผิดไหม เพื่อที่จะแก้ไขให้ถูกต้องและส่ง
```
...
```text
เหมือนก้ับแผนแรกครับ โดยนำ input องศาเก่ามาเทียบกับองศาที่ต้องการนำมาใส่ใน if else โดยหากตรงเงื่อนไขจะทำการแปลงเป็นองศาเซลเซียสก่อนจึงเปลี่ยนเป็นองศาที่ต้องการอีกครั้งหนึ่ง โดยมีเพื่อนคอยแนะนำอีกครั้งในการแปลงจาก R ไป F
```
...
```text
เป็นเงื่อนไขที่ผมติดมานานครับเนื่องจากผมเขียนสมการผิดในขณะนั้น
```
...
```text
ลองเปลี่ยนจาก K ไป C และเป็นค่าติดลบเพื่อดูว่าสมการถูกต้องครบหรือไม่
```
...
```text
เปลี่ยนจาก C ไป F เพื่อตรวจความถูกต้องในส่วนของสูตรในองศาเซลเซียสเป็นองศาอื่น
```
